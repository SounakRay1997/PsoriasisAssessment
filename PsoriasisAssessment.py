...
class correctionWindow(QtGui.QMainWindow):
    ...
    def applyChanges(self):
        ...
        _, contours1, hierarchy1 = cv2.findContours(
            im_bw1, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE
        )
        ...
        im22, contours2, hierarchy2 = cv2.findContours(
            im_bw2, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE
        )
        ...
        im23, contours3, hierarchy3 = cv2.findContours(
            im_bw3, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE
        )
    ...
    def retranslateUi(self):
        ...
        self.actionApply_changes.setText(
...
class DiseasedWindow(QtGui.QMainWindow):
    def __init__(self):
        ...
        self.actionSave_current_image.setObjectName(
            _fromUtf8("actionSave_current_image")
        )
    ...
    def saveCurrent(self):
        ...
        fname1 = QtGui.QFileDialog.getSaveFileName(
            None, "SaveFile", "", "Image file(*.png *.jpg *.bmp *.jpeg)"
        )
        c = str(fname1)
    ...
    def retranslateUi(self):
        ...
        self.actionDo_corrections.setText(
            _translate("MainWindow", "Do corrections", None)
        )
        self.actionSave_current_image.setText(
...
class correctionWindow2(QtGui.QMainWindow):
    ...
    def openImage(self):
        ...
        self.scene.addPixmap(
            QtGui.QPixmap(currentPath + "temporary/diseasedDetectedFromModel.jpg")
        )
    ...
    def applyChanges(self):
        ...
        un, counts = np.unique(DisMask, return_counts=True)
        _, contours1, hierarchy1 = cv2.findContours(
            DisMask, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE
        )
...
class UniformityReport(QtGui.QMainWindow):
    def __init__(self, max_len, min_len, notrap):
        ...
        self.label = QtGui.QLabel(
            "The maximum thickness of the Epidermis is " + str(max_len) + " pixels",
            self,
        )
        self.label.setGeometry(QtCore.QRect(50, 30, 320, 17))
        self.label.setObjectName(_fromUtf8("label"))
        self.label_2 = QtGui.QLabel(
            "The minimum thickness of the Epidermis is " + str(min_len) + " pixels",
            self,
        )
        self.label_2.setGeometry(QtCore.QRect(50, 80, 320, 17))
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.label_3 = QtGui.QLabel(
            "The total number of trapped dermis regions are " + str(notrap), self
        )
...
class UniformitySCReport(QtGui.QMainWindow):
    def __init__(self, max_len, min_len):
        ...
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.label = QtGui.QLabel(
            "The maximum thickness of the Stratum Corneum is "
            + str(max_len)
            + " pixels",
            self,
        )
        ...
        self.label.setObjectName(_fromUtf8("label"))
        self.label_2 = QtGui.QLabel(
            "The minimum thickness of the Stratum Corneum is "
            + str(min_len)
            + " pixels",
            self,
        )
...
class munroMicroabscessDialog(QtGui.QDialog):
    def __init__(self, regions):
        ...
        self.label = QtGui.QLabel(
            "There is a total of "
            + str(regions)
            + " regions detected to have Munro's microabscess",
            self,
        )
        ...
        QtCore.QObject.connect(
            self.buttonBox, QtCore.SIGNAL(_fromUtf8("accepted()")), self.ok
        )
        QtCore.QObject.connect(
            self.buttonBox, QtCore.SIGNAL(_fromUtf8("rejected()")), self.cancel
        )
...
class SegmentationWindow(QtGui.QTabWidget):
    ...
    def retranslateUi(self):
        ...
        self.setTabText(
            self.indexOf(self.tab), _translate("TabWidget", "Epidermis", None)
        )
        self.setTabText(
            self.indexOf(self.tab1), _translate("TabWidget", "Dermis", None)
        )
        self.setTabText(
            self.indexOf(self.tab_2), _translate("TabWidget", "Non-Tissue", None)
        )
        self.pushButton.setText(
            _translate("TabWidget", "Get Histopathology Report", None)
        )
        ...
        self.pushButton_6.setText(
            _translate("TabWidget", "Save Non-Tissue Image", None)
        )
    ...
    def __init__(self, e, s, i):
        ...
        if e == 0 and s == 0:
            ...
            self.lbl2 = QtGui.QLabel(
                "On a scale of 0 to 3, the person has an Induration level of " + str(i),
                self,
            )
            ...
            self.resize(450, 100)
            self.lbl2 = QtGui.QLabel(
                "On a scale of 0 to 4, the person has an Scaling level of " + str(s),
                self,
            )
            self.lbl2.setGeometry(10, 40, 400, 30)
        elif i == 0 and s == 0:
            self.resize(450, 100)
            self.lbl2 = QtGui.QLabel(
                "On a scale of 0 to 4, the person has an Erythema level of " + str(e),
                self,
            )
            self.lbl2.setGeometry(10, 40, 400, 30)
        elif e == 0:
...
class AdvancedOptions(QtGui.QDialog):
    def __init__(self):
        ...
        self.retranslateUi()
        QtCore.QObject.connect(
            self.buttonBox, QtCore.SIGNAL(_fromUtf8("accepted()")), self.accept
        )
        QtCore.QObject.connect(
            self.buttonBox, QtCore.SIGNAL(_fromUtf8("rejected()")), self.reject
        )
...
class AdapThreshold(QtGui.QDialog):
    ...
    def retranslateUi(self):
        ...
        self.checkBox.setText(
            _translate("Dialog", "Mean of the Values in the Block Size", None)
        )
        self.checkBox_2.setText(
            _translate("Dialog", "Weighted Mean of Gaussian Window", None)
        )
...
class Ui_Dialog(QtGui.QDialog):
    ...
    def addFiles(self):
        ...
        fnames = [
            str(f)
            for f in QtGui.QFileDialog.getOpenFileNames(
                None, caption, directory, filter_mask, options=options
            )
        ]
    ...
    def retranslateUi(self):
        ...
        self.checkBox_3.setText(
            _translate("Dialog", "Rename while Batch Processing", None)
        )
        ...
        self.label_5.setText(
            _translate(
                "Dialog", "Change number of # to number images accordingly", None
            )
        )
        ...
        self.groupBox_5.setTitle(
            _translate("Dialog", "Output directory for result files ", None)
        )
        ...
        self.groupBox_6.setTitle(
            _translate("Dialog", "Choose Input Files/Folder", None)
        )
...
class Window(QtGui.QMainWindow):
    def __init__(self):
        ...
        self.actionColor_channel_decomposition.setObjectName(
            _fromUtf8("actionColor_channel_decomposition")
        )
        self.actionColor_channel_decomposition.triggered.connect(
            self.colorChannelDecomposition
        )
        ...
        self.actionSimpleThresholding.setObjectName(
            _fromUtf8("actionSimpleThresholding")
        )
        ...
        self.actionAdaptiveThresholding.setObjectName(
            _fromUtf8("actionAdaptiveThresholding")
        )
        ...
        self.actionSeverityAssessment.setObjectName(
            _fromUtf8("actionSeverityAssessment")
        )
        ...
        self.actionHistopathologySegmentation.setObjectName(
            _fromUtf8("actionHistopathologySegmentation")
        )
        self.actionHistopathologySegmentation.triggered.connect(
            self.histopathologySegmentation
        )
    ...
    def home(self):
        ...
        saveAction = QtGui.QAction(
            QtGui.QIcon(currentPath + "index.jpeg"), "Save", self
        )
        saveAction.triggered.connect(self.save)
        self.toolBar = self.addToolBar("Image Operations")
        self.toolBar.addAction(saveAction)
        saveZoom_In = QtGui.QAction(
            QtGui.QIcon(currentPath + "zoom-in.png"), "Zoom In", self
        )
        saveZoom_In.triggered.connect(self.Zoom_In1)
        self.toolBar.addAction(saveZoom_In)
        saveZoom_Out = QtGui.QAction(
            QtGui.QIcon(currentPath + "zoom-out.png"), "Zoom Out", self
        )
        saveZoom_Out.triggered.connect(self.Zoom_Out1)
        self.toolBar.addAction(saveZoom_Out)
        savePrevious_Image = QtGui.QAction(
            QtGui.QIcon(currentPath + "leftarrow.jpg"), "Previous Image", self
        )
        savePrevious_Image.triggered.connect(self.previousImage)
        self.toolBar.addAction(savePrevious_Image)
        saveNext_Image = QtGui.QAction(
            QtGui.QIcon(currentPath + "rightarrow.jpg"), "Next Image", self
        )
    ...
    def showDialog(self):
        ...
        fname = QtGui.QFileDialog.getOpenFileName(
            None, "OpenFile", "", "Image file(*.png *.jpg *.bmp *.jpeg)"
        )
        if fname != "":
            self.fname = fname
            filename = fname
        ...
        self.cl.graphicsView.fitInView(
            self.cl.scene.sceneRect(), QtCore.Qt.KeepAspectRatio
        )
        global SW
        global DW
        SW.scene = QtGui.QGraphicsScene()
    ...
    def FlipHorizontal(self):
        ...
        self.view.scene = QtGui.QGraphicsScene(self)
        self.view.scene.addPixmap(
            QtGui.QPixmap(currentPath + "temporary/horizontal.png")
        )
        self.view.setScene(self.view.scene)
        self.view.scene.setSceneRect(QtCore.QRectF())
        self.view.fitInView(self.view.scene.sceneRect(), QtCore.Qt.KeepAspectRatio)
    ...
    def RotateRight(self):
        ...
        self.view.scene = QtGui.QGraphicsScene(self)
        self.view.scene.addPixmap(
            QtGui.QPixmap(currentPath + "temporary/rotateright.png")
        )
        self.view.setScene(self.view.scene)
        self.view.scene.setSceneRect(QtCore.QRectF())
        self.view.fitInView(self.view.scene.sceneRect(), QtCore.Qt.KeepAspectRatio)
    ...
    def RotateLeft(self):
        ...
        self.view.scene = QtGui.QGraphicsScene(self)
        self.view.scene.addPixmap(
            QtGui.QPixmap(currentPath + "temporary/rotateleft.png")
        )
        self.view.setScene(self.view.scene)
        self.view.scene.setSceneRect(QtCore.QRectF())
        self.view.fitInView(self.view.scene.sceneRect(), QtCore.Qt.KeepAspectRatio)
            ...
            for fileName in imageList:
                ...
                if self.bp.checkBox.isChecked():
                    ...
                    if self.bp.ao.checkBox_11.isChecked() and width == height:
                        ...
                        ratio = float(self.imgBatch.shape[1]) / float(
                            self.imgBatch.shape[0]
                        )
                ...
                if self.bp.checkBox_2.isChecked():
                    ...
                    self.imgBatch = cv2.resize(
                        self.imgBatch, (0, 0), fx=percent, fy=percent
                    )
                ...
                if self.bp.ao.checkBox_3.isChecked():
                    ...
                    self.imgBatch = cv2.warpAffine(
                        self.imgBatch, rotation_matrix, (num_cols, num_rows)
                    )
                ...
                if self.bp.checkBox_3.isChecked() and self.bp.checkBox_4.isChecked():
                    ...
                    totalFormat = formatString[
                        formatString.rfind(".") : formatString.rfind(" ")
                    ]
                    ...
                    not (self.bp.checkBox_3.isChecked())
                    and self.bp.checkBox_4.isChecked()
                ):
                    formatString = str(self.bp.comboBox.currentText())
                    totalFormat = formatString[
                        formatString.rfind(".") : formatString.rfind(" ")
                    ...
                    fullFileName = str(fullFileName)
                    im.save(fullFileName)
                elif self.bp.checkBox_3.isChecked() and not (
                    self.bp.checkBox_4.isChecked()
                ):
                    imgNumber = ""
                    rename = self.bp.lineEdit_4.text()
                    rename = str(rename)
                    ...
                    fullFileName = str(fullFileName)
                    im.save(fullFileName)
                elif not (self.bp.checkBox_3.isChecked()) and not (
                    self.bp.checkBox_4.isChecked()
                ):
    ...
    def simpleThresholding(self):
        ...
        if td.returnVal == 0:
            ...
            choice = QtGui.QMessageBox.question(
                self,
                "Warning",
                "The image will be converted to gray scale. Are you sure you want to continue?",
            ...
            if choice == QtGui.QMessageBox.Yes:
                ...
                self.view.scene = QtGui.QGraphicsScene(self)
                self.view.scene.addPixmap(
                    QtGui.QPixmap(currentPath + "temporary/sThresholding.png")
                )
                self.view.setScene(self.view.scene)
                self.view.scene.setSceneRect(QtCore.QRectF())
                self.view.fitInView(
                    self.view.scene.sceneRect(), QtCore.Qt.KeepAspectRatio
                )
            else:
                None
        ...
        if at.returnVal == 0:
            ...
            if choice == QtGui.QMessageBox.Yes:
                if at.checkBox.isChecked():
                    ...
                    self.view.scene.addPixmap(
                        QtGui.QPixmap(currentPath + "temporary/aThresholding.png")
                    )
                    self.view.setScene(self.view.scene)
                    self.view.scene.setSceneRect(QtCore.QRectF())
                    self.view.fitInView(
    ...
    def otsu(self):
        ...
        if choice == QtGui.QMessageBox.Yes:
            ...
            self.view.scene = QtGui.QGraphicsScene(self)
            self.view.scene.addPixmap(
                QtGui.QPixmap(currentPath + "temporary/otsuThresholding.png")
            )
            self.view.setScene(self.view.scene)
            self.view.scene.setSceneRect(QtCore.QRectF())
            self.view.fitInView(self.view.scene.sceneRect(), QtCore.Qt.KeepAspectRatio)
    ...
    def severityAssessment(self):
        ...
        if imgCrop == "":
            choice = QtGui.QMessageBox.question(
                self,
                "Important!",
                "Please select an image for Severity Assessment.",
                QtGui.QMessageBox.Yes | QtGui.QMessageBox.No,
            )
            if choice == QtGui.QMessageBox.Yes:
                self.showDialog()
    ...
    def doAssessment(self, imageFileName):
        ...
        if self.cl.returnVal == 1:
            ...
            if (
                not (self.cl.checkBox.isChecked())
                and not (self.cl.checkBox_2.isChecked())
                and not (self.cl.checkBox_3.isChecked())
            ):
                choice = QtGui.QMessageBox.question(
                    self,
                    "Important!",
    ...
    def histopathologySegmentation(self):
        ...
        choice = QtGui.QMessageBox.question(
            self,
            "Important!",
            "Please make the epidermis vertical to calculate it's maximum and minimum width. Are you sure you want to rotate to make the epidermis vertical?",
            QtGui.QMessageBox.Yes | QtGui.QMessageBox.No,
        )
        img11 = img1
        img22 = img2
        ...
        if choice == QtGui.QMessageBox.Yes:
            ...
            rotation_matrix1 = cv2.getRotationMatrix2D(
                (num_cols1 / 2, num_rows1 / 2), -90, 1
            )
        ...
        if choice == QtGui.QMessageBox.Yes:
            ...
            rotation_matrix2 = cv2.getRotationMatrix2D(
                (num_cols2 / 2, num_rows2 / 2), -90, 1
            )
        ...
        if choice == QtGui.QMessageBox.Yes:
            ...
            rotation_matrix3 = cv2.getRotationMatrix2D(
                (num_cols3 / 2, num_rows3 / 2), -90, 1
            )
        ...
        if choice == QtGui.QMessageBox.Yes:
            ...
            rotation_matrix4 = cv2.getRotationMatrix2D(
                (num_cols4 / 2, num_rows4 / 2), -90, 1
            )
    ...
    def mm(self):
        ...
        img = cv2.cvtColor(img, cv2.COLOR_BGR2RGB)
        segments = slic(
            img, n_segments=550, compactness=40, convert2lab=True, max_iter=10, sigma=0
        )
        centro = []
        ...
        neutroModel = load_model(
            currentPath + "neutroPredModelFinal.h5",
            custom_objects={
                "CapsuleLayer": CapsuleLayer,
                "Length": Length,
                "TrimmedAveragePool": TrimmedAveragePool,
            },
        )
        croppedImg = []
        probValues = []
        ...
        croppedImg.sort(key=takeFourth, reverse=True)
        reg = len(croppedImg)
        ...
        if MMDialog.returnVal == 1:
            if MMDialog.checkBox.isChecked():
                ...
                for i in range(last):
                    image = cv2.rectangle(
                        image,
                        ((croppedImg[i])[1], (croppedImg[i])[0]),
                        ((croppedImg[i])[3], (croppedImg[i])[2]),
                        (0, 255, 0),
                        3,
                    )
                im = Image.fromarray(image)
    ...
    def diseaseDetection(self):
        ...
        if imgCrop == "":
            choice = QtGui.QMessageBox.question(
                self,
                "Important!",
                "Please select an image for Disease Detection.",
                QtGui.QMessageBox.Yes | QtGui.QMessageBox.No,
            )
            if choice == QtGui.QMessageBox.Yes:
                self.showDialog()
    ...
    """This function renames all the menu options in the UI.
       This helps the users in choosing the appropriate options easily.
    """
    ...
    def retranslateUi(self):
        ...
        self.actionImage_Information.setText(
            _translate("Window", "Image Information", None)
        )
        self.actionBatch_Processing.setText(
            _translate("Window", "Batch Processing", None)
        )
        ...
        self.actionColor_channel_decomposition.setText(
            _translate("Window", "Color channel decomposition", None)
        )
        self.actionMean_Filtering.setText(_translate("Window", "Mean Filtering", None))
        self.actionMaximum_Filtering.setText(
            _translate("Window", "Maximum Filtering", None)
        )
        self.actionMedian_Filtering.setText(
            _translate("Window", "Median Filtering", None)
        )
        ...
        self.actionSimpleThresholding.setText(
            _translate("Window", "Simple Thresholding", None)
        )
        self.actionOtsu.setText(_translate("Window", "Otsu", None))
        self.actionAdaptiveThresholding.setText(
            _translate("Window", "Adaptive Thresholding", None)
        )
        self.actionSeverityAssessment.setText(
            _translate("Window", "Severity Assessment", None)
        )
        self.actionDiseaseDetection.setText(
            _translate("Window", "Diseased Region Detection", None)
        )
        self.actionHistopathologySegmentation.setText(
            _translate("Window", "Histopathology Segmentation", None)
        )
        self.actionMunrosMicroabcess.setText(
            _translate("Window", "Munro's microabscess", None)
        )
